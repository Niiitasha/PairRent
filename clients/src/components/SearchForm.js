...
=======
                    <label>Smoker?<input className="smoking" type="checkbox" title="smoker" onChange={this.handleInputChange} /></label>
                    <label>Special Needs?<input className="needs" title="needs" type="checkbox" onChange={this.handleInputChange} /></label>
                    ...
                    <label>No Preference?<input className="gender" title="noPreference" name="gender" value="none" type="radio" onChange={this.handleInputChange} /></label>
